...
class todo:
    def __init__(self, root):
        ...
        self.label = Label(self.root, text='To-Do-List-App', font='ariel, 25 bold', width=10,bd=5, bg='#7774db', fg='black')
        self.label.pack(side='top', fill=BOTH)

        self.label2 = Label(self.root, text='Add Task', font='ariel, 18 bold', width=10,bd=5, bg='#7774db', fg='black')
        self.label2.place(x=40, y=54)

        self.label3 = Label(self.root, text='Tasks', font='ariel, 18 bold', width=10,bd=5, bg='#7774db', fg='black')
        ...
        self.button2 = Button(self.root, text='Delete', font='sarif, 20 bold italic', width=10, bg='#7774db',  fg='black', command=delete)
